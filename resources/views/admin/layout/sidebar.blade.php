                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{asset('themes/admin/dashboard-crm.html')}}" class="nav-link" data-key="t-crm"> CRM </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{asset('themes/admin/index.html')}}" class="nav-link" data-key="t-ecommerce"> Ecommerce </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{asset('themes/admin/dashboard-crypto.html')}}" class="nav-link" data-key="t-crypto"> Crypto </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{asset('themes/admin/dashboard-projects.html')}}" class="nav-link" data-key="t-projects"> Projects </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{asset('themes/admin/dashboard-nft.html')}}" class="nav-link" data-key="t-nft"> NFT</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{asset('themes/admin/dashboard-job.html')}}" class="nav-link" data-key="t-job">Job</a>
                            </li>
                        </ul>
                    </div>
